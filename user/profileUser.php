...
<!-- Profile of the comes here -->
    ...
    <div class="profile_div">
        ...
        <div class="div_row">
            <div class="field_name"> <h4>Date of Joining</h4></div>
            <div class="field_value"> <h4><?php echo $array['doj']; ?></h4></div>
        </div> 
        <div class="div_row">
            <div class="field_name"> <h4>Manager</h4></div>
            <div class="field_value"> <h4><?php echo $array['manager']; ?></h4></div>
        </div> 
        <div class="div_row">
            <div class="field_name"> <h4>Project Name</h4></div>
            <div class="field_value" style="width: min-content;"> <h4><?php echo $array['project_name']; ?></h4></div>
        </div> 
        <div class="div_row">
            <div class="field_name"> <h4>Location</h4></div>
            <div class="field_value"> <h4><?php echo $array['location']; ?></h4></div>
        </div> 
        <div class="div_row">
